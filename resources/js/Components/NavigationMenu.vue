...
<template>
    <div>
        <img v-if="!showMenu" src="/img/icons/menu.svg" alt="menu" class="icon" @click="toggleMenu"/>
        <svg v-else xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x icon-x-menu" @click="toggleMenu">
